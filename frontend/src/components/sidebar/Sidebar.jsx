...
const userLinks = [
  ...
  { to: '/new-complaint', label: 'New Complaint', icon: 'M12 4v16m8-8H4' },
  { to: '/complaints', label: 'My Complaints', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
...
const adminLinks = [
  ...
  { to: '/admin/complaints', label: 'All Complaints', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  { to: '/admin/heatmap', label: 'Grievance Heatmap', icon: 'M12 2a10 10 0 100 20 10 10 0 000-20zm1 17.93V19a1 1 0 00-2 0v.93A8 8 0 0112 4a8 8 0 017.93 7h-.93a1 1 0 000 2h.93a8 8 0 01-7 6.93zM12 13a2 2 0 110-4 2 2 0 010 4z' },
  ...
  { to: '/admin/analytics', label: 'Analytics', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
